...
% ---------------------------------------------------------------------------
Incoporating external source information with parametric knowledge from large-
language models to provide a comphrensive and grounded response to the users has
...
that makes it well-suited to explore questions of RAG evaluation generation: 
...
generation models are increasingly multilingual and capable of incorpoarting 
...
% Keynote
% ---------------------------------------------------------------------------
We are delighted to host a keynote talk by Chris Callison-Burch (University
of Pennsylvania) [PLACEHOLDER: one-sentence framing of the keynote topic
once confirmed --- e.g., ``on [topic], which speaks directly to [the
workshop theme]''].
...
the benchmark and pushing its limits; and the TIRA team, particularly Maik Froebe, 
